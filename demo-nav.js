...
(function () {
  ...
  var KB = [
    ...
    { k: ['collect', 'refile', 'appeal', 'negotiat', 'balance', 'recover', 'payment'], a: 'On Payments & Collections you post payments per CPT over time, work underpayments through refile/appeal and Pro/Tech negotiation, and keep collecting until you close the claim or send it to Arbitration for arbitration.' },
