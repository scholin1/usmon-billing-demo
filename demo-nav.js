...
(function () {
  ...
  var PAGES = [
    ...
    { f: 'prototype-classic.html', label: 'Classic', group: 'Styles' },
  ...
  var BLURB = {
    ...
    'prototype-classic.html': 'the Classic view - the legacy USMON look and workflow (the dense grid, the familiar tabs and column names) running on the new engine, so change-resistant billers keep the screen they know while still getting AI help, validation, and the deadline clocks. Can be set as a per-biller default.',
    'prototype-scrub.html': 'the Pre-Submission Scrub - the modern version of the old "Information Required" popup: a continuous, ranked, payer-and-channel-aware check that proposes the fix for each issue (you confirm), pre-flights the clearinghouse edits, predicts denial and underpayment risk, then routes the clean claim to 837P or paper.',
